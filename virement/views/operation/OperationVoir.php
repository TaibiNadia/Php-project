...
?>
<h2 class="display-4">Detail d'une Operation</h2>	<BR><BR>
...
<div class="row">
	...
	<div>
		...
		<a href="../../controllers/operation/operationListerCl.php"><input type="button" name="Retour" value="Retour " class="btn btn-danger col"/>
	</div>
	</div>
</div>	
</fieldset>
